...
$mediaCount = isset($mediaCount) ? $mediaCount : count($media);
?>
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2>
                    ...
                    <span class="badge bg-primary"><?= $mediaCount ?> media item<?= $mediaCount !== 1 ? 's' : '' ?></span>
                </h2>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-film"></i> Media with this Tag</h5>
                </div>
                <div class="card-body">
                    <?php if (empty($media)): ?>
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle"></i> No media are currently tagged with "<?= esc($tag['name']) ?>".
                        </div>
                    <?php else: ?>
