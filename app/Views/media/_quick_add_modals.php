        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="loanMovieModalLabel">
                    <i class="bi bi-person-check"></i> Loan Media
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="loanMovieForm">
                    ...
                    <div class="text-muted small">
                        <i class="bi bi-info-circle"></i> The media will be marked as loaned out to the selected person.
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.showLoanModal = function(callback, cancelCallback) {
        ...
        fetch('<?= base_url('media/getPeople') ?>', {
            method: 'GET',
            headers: { 
    ...
    if (addCollectionBtn) {
        ...
        document.getElementById('saveNewCollectionBtn').addEventListener('click', function() {
            ...
            fetch('<?= base_url('media/addCollection') ?>', {
                method: 'POST',
                headers: { 
                    'X-Requested-With': 'XMLHttpRequest'
                },
    ...
    if (addVolumeBtn) {
        ...
        document.getElementById('saveNewVolumeBtn').addEventListener('click', function() {
            ...
            fetch('<?= base_url('media/addVolume') ?>', {
                method: 'POST',
                headers: { 
                    'X-Requested-With': 'XMLHttpRequest'
                },
