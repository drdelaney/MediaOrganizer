    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="<?= base_url('movies/view/' . $movie['movie_id']) ?>" class="btn btn-outline-secondary me-2">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5><i class="bi bi-image"></i> Movie Poster</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <div class="d-flex align-items-center h-100">
                                <div>
                                    <h6 class="mb-3">Current Movie: <?= esc($movie['title'] ?: $movie['o_title'] ?: 'Untitled') ?></h6>
                                    <?php if ($movie['poster_md5']): ?>
                                        ...
                                        <p class="text-muted mb-3">
                                            <small>Last updated: <?= $movie['updated'] ? date('M d, Y H:i', strtotime($movie['updated'])) : 'Unknown' ?></small>
                                        </p>
                                    <?php else: ?>
                                        <p class="text-muted mb-3">
                                    ...
                                    <?php if (isset($apiAvailable) && $apiAvailable): ?>
                                        <div class="alert alert-info py-2">
                                            <small>
                                                ...
                                                Use the "Fetch Movie Data from TMDB" button below to automatically download a poster for this movie.
                                            </small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-start">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="text-center">
                                    <?php if ($movie['poster_md5']): ?>
                                        <img id="existing-poster-img" src="<?= base_url('movies/poster/' . $movie['movie_id']) . '?v=' . urlencode($movie['poster_md5']) ?>" class="img-fluid rounded shadow-sm" alt="Existing Poster" style="max-height: 260px; max-width: 180px;">
                                    <?php else: ?>
                        ...
                        <small class="text-muted">Choose to keep the existing poster, use the newly fetched one, or select "No poster" to remove it. Your selection will be applied when you click "Update Movie". Cancel will discard any fetched changes.</small>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <div class="card bg-light">
                                        ...
                                        <div class="card-body">
                                            <p class="text-muted mb-3">
                                                Automatically fetch movie or TV information from The Movie Database (TMDB).
                                                This will fill in fields like plot, cast, runtime, and prepare a poster preview.
                                                Changes are not saved until you click "Update Movie".
                                            </p>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success btn-lg me-3">
                                <i class="bi bi-check-lg"></i> Update Movie
                            </button>
                            <a href="<?= base_url('movies/view/' . $movie['movie_id']) ?>" class="btn btn-secondary btn-lg me-3">
                                <i class="bi bi-x-lg"></i> Cancel
                            </a>
                            <a href="<?= base_url('movies') ?>" class="btn btn-outline-secondary btn-lg">
                                <i class="bi bi-arrow-left"></i> Back to Library
                            </a>
                        </div>
                    </div>
            ...
            if (fetchBtn) {
                fetchBtn.addEventListener('click', function() {
                    ...
                    fetch(`<?= base_url('movies/fetchFromApi/') ?>${movieId}`, {
                        ...
                        .catch(() => {
                            showMessage('An error occurred while fetching movie data', 'error');
                        })
                        .finally(() => {
                            this.disabled = false;
